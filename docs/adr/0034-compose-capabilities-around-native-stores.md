# 0034: Compose capabilities around native stores

Status: superseded by [ADR 0030](0030-use-fixed-resources-with-native-codex.md).
Historical record restored 2026-09-08 from the parent of commit `6862085e73d8`.
Former identifier: `0030-compose-capabilities-around-native-stores.md`; that
number was reused for its replacement. The original rationale follows; its
packs, transport, provider and retired-harness details are historical.
