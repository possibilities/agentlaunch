...
Claude plugin, explicit Pi paths with ambient discovery disabled, and qualified
Codex skills from the globally installed skills-only `agent` plugin. Codex
...
guidance, shims, Pi utilities, and Herdr integration remain.
