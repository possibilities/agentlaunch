 ...
 * cascade, whose choices come pre-validated from the catalog — an invalid
 * pair can never be on screen.
 */

/** The catalog's choice space as the form consumes it, mapped from the
 * loaded catalog by the shell. */
...
export function currentHarness(state: FormState): FormHarness {
...
export interface LaunchPlan {
   ...
   * /agent:name for Claude or $agent:name for Codex; null when none. */
  priming: string | null;
}
