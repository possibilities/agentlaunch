...
const yoloShape = {
  claude: z
    .boolean()
    .describe(
      "Inject --dangerously-skip-permissions into claude launches. Defaults to true when omitted.",
    )
    .optional(),
  codex: z
    .boolean()
