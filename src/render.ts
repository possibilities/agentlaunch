...
export function renderTopHelp(): string {
  ...
  lines.push(
    ...
    "",
    "Environment:",
    "  config.json: balance is a boolean or {claude: boolean, codex: boolean}; defaults on",
    "  AGENTLAUNCH_NO_BALANCE=1          Disable balancing for both harnesses",
    "  AGENTLAUNCH_CLAUDE_NO_BALANCE=1   Disable Claude balancing",
    "  AGENTLAUNCH_CODEX_NO_BALANCE=1    Disable Codex balancing",
    "  Any nonempty disable variable overrides config (including 0); unset to restore config",
